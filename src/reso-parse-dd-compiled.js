...
var parseResoWikiXML = function parseResoWikiXML(pathToXmlSource, options, callback) {
    ...
    _xmlToJson(sourcePath, function (err, jsonData) {
        if (typeof jsonData !== 'undefined') {
            ...
            // document info
            var doc = new Subject('<>', 'owl:Ontology').addValue('dc:title', 'Real Estate Standards Vocabulary (RESO)').addValue('dc:description', 'Mapping of the RESO Data Dictionary to RDF.').addValue('rdfs:label', 'RESO Data Diction - RDF Vocabulary').addValue('dc:publisher', 'http://www.reso.org').addValue('dc:creator', "_:DaveDuran");

            var creator = new Subject('_:DaveDuran', 'schema:Person').addValue('schema:name', 'Dave Duran').addValue('schema:email', 'dave@yodata.io');
            ...
            resources.forEach(function (resource) {
                ...
                var subject = new Subject(classCURI, 'rdfs:Class').addValue('rdfs:label', classLabel).addValue('rdfs:comment', classComment).addValue('schema:sameAs', classWikiURL, 'IRI');
            ...
            if (config.parse.properties) {
                ...
                resources.forEach(function (resource) {
                    ...
                    resourceProperties.forEach(function (prop) {
                        ...
                        subject.addValue('rdfs:label', propLabel).addValue('rdfs:domain', classCURI, 'id').addValue('schema:sameAs', propWikiURL);
...
module.exports = { config: config, parseResoWikiXML: parseResoWikiXML };

//# sourceMappingURL=reso-parse-dd-compiled.js.map